...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    // private int indicatorColor = R.color.dodger_blue;
    ...
    private int scrollOffset = 37;
    private int tabPadding = 8;

    private int tabTextSize = 16;
    private int tabTextCurrentSize = 18;
    private int tabTextColor = R.color.grey;
    private Typeface tabTypeface = null;
    private int tabTypefaceStyle = Typeface.BOLD;

    private int lastScrollX = 0;

    private int tabBackgroundResId = R.drawable.ic_chat_background_tab;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs,
        ...
        tabTextCurrentSize = (int) TypedValue.applyDimension(
                TypedValue.COMPLEX_UNIT_SP, tabTextCurrentSize, dm);
        ...
        tabTextCurrentSize = a.getDimensionPixelSize(0, tabTextCurrentSize);
    ...
    private void updateTabStyles() {
        for (int i = 0; i < tabCount; i++) {
            ...
            if (v instanceof TextView) {
                ...
                int mItem = pager.getCurrentItem();
                if (i == mItem) {
                    tab.setTextSize(16);// TypedValue.COMPLEX_UNIT_PX,
                    // tabTextCurrentSize);
                    tab.setTextColor(getResources().getColor(
                            R.color.blue));
                } else {
                    tab.setTextColor(getResources().getColor(R.color.grey));// (tabTextColor);
                    tab.setTextSize(14);// (TypedValue.COMPLEX_UNIT_PX,
                    // tabTextSize);
                }
